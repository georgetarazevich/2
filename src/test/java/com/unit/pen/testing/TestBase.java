...
import com.unit.pen.testing.Pen;
...
public class TestBase {
	...
	@DataProvider(name = "testingInkContainer_TrueValue")
	public Object[][] createPens_InkContainer_TrueValue() {
		return new Object[][] {
				...
				new Object[] { new Pen(inkContainerValue, sizeLetterValue, color) } };
	}

	@DataProvider(name = "testingInkContainer_FalseValue")
	public Object[][] createPens_InkContainer_FalseValue() {
		return new Object[][] {
				...
				new Object[] { new Pen(inkContainerZeroValue, sizeLetterValue, color) },
				new Object[] { new Pen(inkContainerZeroValue - 1) },
				new Object[] { new Pen(inkContainerZeroValue - 1, sizeLetterValue) },
				new Object[] { new Pen(inkContainerZeroValue - 1, sizeLetterValue, color) } };
	}

	@DataProvider(name = "testingSizeLetter_FalseValue")
	public Object[][] createPens_SizeLetter_FalseValue() {
		return new Object[][] {
				new Object[] { new Pen(inkContainerValue, sizeLetterZeroValue) },
				new Object[] { new Pen(inkContainerValue, sizeLetterZeroValue - 1, color) } };
	}
